...
public class EnemyTankMovement : MonoBehaviour
{
    ...
    // A reference to the nav mesh agent componet
    private NavMeshAgent m_NavAgent;
    // A reference to the rigidbody component
    private Rigidbody m_Rigidbody;

    // Will be set true when this tank should follow the player
    ...
    {
        // When the tank is turned off, set it to kinamatic so it stops moving
